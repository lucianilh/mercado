...
def comprar_produto() -> None:
    if len(produtos) > 0:
        print('Informe o código do produto que deseja acidionar ao carrinho: ')
        print('--------------------------------------------------------------')
            ...
            if len(carrinho) > 0:
                ...
                for item in carrinho:
                    ...
                    if quant:
                        ...
                        print(f'O {produto.nome} agora possui {quant + 1} unidades no carrinho.')
...
def vizualizar_carrinho() -> None:
    if len(carrinho) > 0:
        ...
        print('Ainda não exisetem produtos no carrinho.')
    sleep(2)
    menu()
